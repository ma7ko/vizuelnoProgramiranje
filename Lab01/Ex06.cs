...
namespace ConsoleApp2
{
    class Program
    {
        ...
        public void analiziraj(double[] niza, double el)
        {
            double max = 0, min = 1000, midval = 0;
            ...
            Console.WriteLine("The middle value of the sequence of numbers is {0}", midval / el);
